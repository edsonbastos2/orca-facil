...
<critical>Faça uma task por vez na ordem de sequencia, quando finalizar a task marque como completa e só vá para a proxima após minha confirmação</critical>

<critical>Nunca vá para outra task antes de finalizar a anterior</critical>
